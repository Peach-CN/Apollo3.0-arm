...
_SERIALCONF = _descriptor.Descriptor(
  name='SerialConf',
  full_name='apollo.drivers.ultrasonic_radar.SerialConf',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='device', full_name='apollo.drivers.ultrasonic_radar.SerialConf.device', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='baud_rate', full_name='apollo.drivers.ultrasonic_radar.SerialConf.baud_rate', index=1,
...
_ULTRASONICRADARCONF = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='serial_conf', full_name='apollo.drivers.ultrasonic_radar.UltrasonicRadarConf.serial_conf', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='entrance_num', full_name='apollo.drivers.ultrasonic_radar.UltrasonicRadarConf.entrance_num', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='type', full_name='apollo.drivers.ultrasonic_radar.UltrasonicRadarConf.type',
...
_ULTRASONICRADARCONF.fields_by_name['serial_conf'].message_type = _SERIALCONF
_ULTRASONICRADARCONF.oneofs_by_name['type'].fields.append(
  _ULTRASONICRADARCONF.fields_by_name['can_conf'])
_ULTRASONICRADARCONF.fields_by_name['can_conf'].containing_oneof = _ULTRASONICRADARCONF.oneofs_by_name['type']
_ULTRASONICRADARCONF.oneofs_by_name['type'].fields.append(
  _ULTRASONICRADARCONF.fields_by_name['serial_conf'])
_ULTRASONICRADARCONF.fields_by_name['serial_conf'].containing_oneof = _ULTRASONICRADARCONF.oneofs_by_name['type']
DESCRIPTOR.message_types_by_name['CanConf'] = _CANCONF
DESCRIPTOR.message_types_by_name['SerialConf'] = _SERIALCONF
...
SerialConf = _reflection.GeneratedProtocolMessageType('SerialConf', (_message.Message,), dict(
  DESCRIPTOR = _SERIALCONF,
  __module__ = 'modules.drivers.radar.ultrasonic_radar.proto.ultrasonic_radar_conf_pb2'
  # @@protoc_insertion_point(class_scope:apollo.drivers.ultrasonic_radar.SerialConf)
  ))
_sym_db.RegisterMessage(SerialConf)
