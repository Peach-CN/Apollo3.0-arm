...
_RANGEINFO_CONSTELLATION = _descriptor.EnumDescriptor(
  name='Constellation',
  full_name='apollo.drivers.gnss.RangeInfo.Constellation',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_RANGEINFO = _descriptor.Descriptor(
  name='RangeInfo',
  full_name='apollo.drivers.gnss.RangeInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='constellation', full_name='apollo.drivers.gnss.RangeInfo.constellation', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prn', full_name='apollo.drivers.gnss.RangeInfo.prn', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='carrier_frequency', full_name='apollo.drivers.gnss.RangeInfo.carrier_frequency', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pseudorange', full_name='apollo.drivers.gnss.RangeInfo.pseudorange', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pseudorange_std_dev', full_name='apollo.drivers.gnss.RangeInfo.pseudorange_std_dev', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='carrier_phase', full_name='apollo.drivers.gnss.RangeInfo.carrier_phase', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='carrier_phase_std_dev', full_name='apollo.drivers.gnss.RangeInfo.carrier_phase_std_dev', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doppler', full_name='apollo.drivers.gnss.RangeInfo.doppler', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doppler_std_dev', full_name='apollo.drivers.gnss.RangeInfo.doppler_std_dev', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cno', full_name='apollo.drivers.gnss.RangeInfo.cno', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lock_time', full_name='apollo.drivers.gnss.RangeInfo.lock_time', index=10,
...
_GNSSRANGE = _descriptor.Descriptor(
  name='GnssRange',
  full_name='apollo.drivers.gnss.GnssRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='header', full_name='apollo.drivers.gnss.GnssRange.header', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='measurement_time', full_name='apollo.drivers.gnss.GnssRange.measurement_time', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ranges', full_name='apollo.drivers.gnss.GnssRange.ranges', index=2,
...
_GNSSRANGE.fields_by_name['header'].message_type = modules_dot_common_dot_proto_dot_header__pb2._HEADER
