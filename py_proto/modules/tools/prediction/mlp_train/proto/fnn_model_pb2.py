...
Vector = _reflection.GeneratedProtocolMessageType('Vector', (_message.Message,), dict(
  DESCRIPTOR = _VECTOR,
  __module__ = 'modules.tools.prediction.mlp_train.proto.fnn_model_pb2'
