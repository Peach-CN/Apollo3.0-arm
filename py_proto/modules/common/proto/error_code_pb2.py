...
_ERRORCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RELATIVE_MAP_ERROR', index=29, number=11000,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RELATIVE_MAP_NOT_READY', index=30, number=11001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DRIVER_ERROR_GNSS', index=31, number=12000,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DRIVER_ERROR_VELODYNE', index=32, number=13000,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NAVI_GENERATOR_ERROR_DATABASE', index=33, number=15000,
      options=None,
      type=None),
  ],
...
NAVI_GENERATOR_ERROR_DATABASE = 15000
