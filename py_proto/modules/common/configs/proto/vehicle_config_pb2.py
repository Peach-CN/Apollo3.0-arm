...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  serialized_pb=_b('\n1modules/common/configs/proto/vehicle_config.proto\x12\rapollo.common\x1a!modules/common/proto/header.proto\x1a#modules/common/proto/geometry.proto\"\x91\x01\n\tTransform\x12\x14\n\x0csource_frame\x18\x01 \x01(\x0c\x12\x14\n\x0ctarget_frame\x18\x02 \x01(\x0c\x12+\n\x0btranslation\x18\x03 \x01(\x0b\x32\x16.apollo.common.Point3D\x12+\n\x08rotation\x18\x04 \x01(\x0b\x32\x19.apollo.common.Quaternion\"9\n\nExtrinsics\x12+\n\ttansforms\x18\x01 \x03(\x0b\x32\x18.apollo.common.Transform\"\xcf\x04\n\x0cVehicleParam\x12\x37\n\x05\x62rand\x18\x01 \x01(\x0e\x32(.apollo.common.VehicleParam.VehicleBrand\x12\x1c\n\x14\x66ront_edge_to_center\x18\x02 \x01(\x01\x12\x1b\n\x13\x62\x61\x63k_edge_to_center\x18\x03 \x01(\x01\x12\x1b\n\x13left_edge_to_center\x18\x04 \x01(\x01\x12\x1c\n\x14right_edge_to_center\x18\x05 \x01(\x01\x12\x0e\n\x06length\x18\x06 \x01(\x01\x12\r\n\x05width\x18\x07 \x01(\x01\x12\x0e\n\x06height\x18\x08 \x01(\x01\x12\x17\n\x0fmin_turn_radius\x18\t \x01(\x01\x12\x18\n\x10max_acceleration\x18\n \x01(\x01\x12\x18\n\x10max_deceleration\x18\x0b \x01(\x01\x12\x17\n\x0fmax_steer_angle\x18\x0c \x01(\x01\x12\x1c\n\x14max_steer_angle_rate\x18\r \x01(\x01\x12\x1c\n\x14min_steer_angle_rate\x18\x0e \x01(\x01\x12\x13\n\x0bsteer_ratio\x18\x0f \x01(\x01\x12\x12\n\nwheel_base\x18\x10 \x01(\x01\x12\x1c\n\x14wheel_rolling_radius\x18\x11 \x01(\x01\x12\"\n\x1amax_abs_speed_when_stopped\x18\x12 \x01(\x02\"T\n\x0cVehicleBrand\x12\x0f\n\x0bLINCOLN_MKZ\x10\x00\x12\x07\n\x03GEM\x10\x01\x12\x06\n\x02\x43H\x10\x02\x12\n\n\x06\x41GILEX\x10\x04\x12\x0b\n\x07\x41GRIBOT\x10\x05\x12\t\n\x05LOTUS\x10\x06\"\x99\x01\n\rVehicleConfig\x12%\n\x06header\x18\x01 \x01(\x0b\x32\x15.apollo.common.Header\x12\x32\n\rvehicle_param\x18\x02 \x01(\x0b\x32\x1b.apollo.common.VehicleParam\x12-\n\nextrinsics\x18\x03 \x01(\x0b\x32\x19.apollo.common.Extrinsics')
  ,
...
_VEHICLEPARAM_VEHICLEBRAND = _descriptor.EnumDescriptor(
  name='VehicleBrand',
  full_name='apollo.common.VehicleParam.VehicleBrand',
  filename=None,
  file=DESCRIPTOR,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AGILEX', index=3, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AGRIBOT', index=4, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOTUS', index=5, number=6,
      options=None,
      type=None),
  ],
...
_sym_db.RegisterEnumDescriptor(_VEHICLEPARAM_VEHICLEBRAND)
...
_VEHICLEPARAM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='front_edge_to_center', full_name='apollo.common.VehicleParam.front_edge_to_center', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='back_edge_to_center', full_name='apollo.common.VehicleParam.back_edge_to_center', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='left_edge_to_center', full_name='apollo.common.VehicleParam.left_edge_to_center', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='right_edge_to_center', full_name='apollo.common.VehicleParam.right_edge_to_center', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='length', full_name='apollo.common.VehicleParam.length', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='apollo.common.VehicleParam.width', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='height', full_name='apollo.common.VehicleParam.height', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_turn_radius', full_name='apollo.common.VehicleParam.min_turn_radius', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_acceleration', full_name='apollo.common.VehicleParam.max_acceleration', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_deceleration', full_name='apollo.common.VehicleParam.max_deceleration', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_steer_angle', full_name='apollo.common.VehicleParam.max_steer_angle', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_steer_angle_rate', full_name='apollo.common.VehicleParam.max_steer_angle_rate', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_steer_angle_rate', full_name='apollo.common.VehicleParam.min_steer_angle_rate', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='steer_ratio', full_name='apollo.common.VehicleParam.steer_ratio', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wheel_base', full_name='apollo.common.VehicleParam.wheel_base', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wheel_rolling_radius', full_name='apollo.common.VehicleParam.wheel_rolling_radius', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_abs_speed_when_stopped', full_name='apollo.common.VehicleParam.max_abs_speed_when_stopped', index=17,
...
_VEHICLEPARAM.fields_by_name['brand'].enum_type = _VEHICLEPARAM_VEHICLEBRAND
_VEHICLEPARAM_VEHICLEBRAND.containing_type = _VEHICLEPARAM
