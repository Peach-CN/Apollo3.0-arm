...
_MEASURESTATE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NOT_STABLE', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
