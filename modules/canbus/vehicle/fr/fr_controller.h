...
#ifndef MODULES_CANBUS_VEHICLE_FR_FR_PROTOCOL_MANAGER_H_
#define MODULES_CANBUS_VEHICLE_FR_FR_PROTOCOL_MANAGER_H_
...
class FrController final : public VehicleController {
 public:

  explicit FrController() {};
 ...
 private:
  // control protocol
  Ctrlcmd98c4d2d0* ctrl_cmd_98c4d2d0_ = nullptr;
  Iocmd98c4d7d0* io_cmd_98c4d7d0_ = nullptr;
...
#endif  // MODULES_CANBUS_VEHICLE_FR_FR_PROTOCOL_MANAGER_H_
