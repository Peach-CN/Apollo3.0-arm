...
#ifndef MODULES_CANBUS_VEHICLE_FR_PROTOCOL_RR_WHEEL_FB_98C4D8EF_H_
#define MODULES_CANBUS_VEHICLE_FR_PROTOCOL_RR_WHEEL_FB_98C4D8EF_H_
...
class Rrwheelfb98c4d8ef : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double rr_wheel_fb_velocity(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int rr_wheel_fb_pulse(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int rr_wheel_fb_check_bcc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int rr_wheel_fb_alive_cnt(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_FR_PROTOCOL_RR_WHEEL_FB_98C4D8EF_H_
