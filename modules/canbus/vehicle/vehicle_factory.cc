...
#include "modules/canbus/vehicle/fr/fr_vehicle_factory.h"

//#include "modules/canbus/vehicle/lotus_fr07/lotus_fr07_vehicle_factory.h"
...
/*
  Register(VehicleParameter::LOTUS_FR07, []() -> AbstractVehicleFactory * {
    return new LotusFr07VehicleFactory();
  });
*/
  Register(VehicleParameter::FR, []() -> AbstractVehicleFactory * {
    return new FrVehicleFactory();
  });
}
