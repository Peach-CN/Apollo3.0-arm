...
DEFINE_bool(use_3rdpart_obstacle_detection, true,
            "whether to use thirdparty obstacle detection result");
DEFINE_bool(enable_cnn_lane_detection, true,
            "whether to do lane line detection");
DEFINE_int32(input_image_height, 1080, "image height");
DEFINE_int32(input_image_width, 1920, "image width");
DEFINE_int32(inference_blob_input_width, 960, "model input width");
DEFINE_int32(inference_blob_input_height, 384, "model input height");
