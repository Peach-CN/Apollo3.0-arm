...
DECLARE_bool(use_3rdpart_obstacle_detection);
DECLARE_bool(enable_cnn_lane_detection);
DECLARE_int32(input_image_height);
DECLARE_int32(input_image_width);
DECLARE_int32(inference_blob_input_width);
DECLARE_int32(inference_blob_input_height);
