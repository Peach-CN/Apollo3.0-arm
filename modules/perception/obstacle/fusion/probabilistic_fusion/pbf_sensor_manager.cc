...
bool PbfSensorManager::Init() {
  ...
  sensor_id = GetSensorType(SensorType::VELODYNE_16);
  type = SensorType::VELODYNE_16;
  PbfSensor *velodyne_16 = new PbfSensor(sensor_id, type);
  sensors_[sensor_id] = velodyne_16;

  sensor_id = GetSensorType(SensorType::CAMERA);
  type = SensorType::CAMERA;
  PbfSensor *camera = new PbfSensor(sensor_id, type);
  sensors_[sensor_id] = camera;
