...
#include "rt_net/include/inference.h"
#include "rt_net/include/syncedmem.h"
...
class RTNetYoloCameraDetector : public BaseCameraDetector {
 public:
  RTNetYoloCameraDetector() : BaseCameraDetector() {}

  virtual ~RTNetYoloCameraDetector() {}
 ...
 private:
  ...
  std::shared_ptr<apollo::perception::base::SyncedMemory> rt_net_res_cls_tensor_ = nullptr;
  std::shared_ptr<apollo::perception::base::SyncedMemory> rt_net_res_box_tensor_ = nullptr;

  std::shared_ptr<apollo::perception::base::SyncedMemory> rt_net_image_data_ = nullptr;
  std::shared_ptr<apollo::perception::base::SyncedMemory> rt_net_image_data_lane_ = nullptr;
  std::shared_ptr<apollo::perception::base::SyncedMemory> rt_net_overlapped_ = nullptr;
  std::shared_ptr<apollo::perception::base::SyncedMemory> rt_net_idx_sm_ = nullptr;
  std::shared_ptr<apollo::perception::base::SyncedMemory> rt_net_anchor_ = nullptr;
  int height_ = 0;
  int width_ = 0;
  float min_2d_height_ = 0.0f;
  float min_3d_height_ = 0.0f;
  ...
  int lane_output_width_ = 0;
  int num_anchors_ = 10;
  std::vector<boost::shared_ptr<RTNetBaseFeatureExtractor>> extractors_;
  std::vector<ObjectType> types_;
  int offset_y_ = 0;
  NMSParam nms_;
  float inter_cls_nms_thresh_ = 1.0f;
...
REGISTER_CAMERA_DETECTOR(RTNetYoloCameraDetector);
