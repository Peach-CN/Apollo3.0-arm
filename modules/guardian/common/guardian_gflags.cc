...
DEFINE_int32(ultrasonic_radar_count, 12,
              "use to init simple count");

DEFINE_string(ultrasonic_radar_config_filename,
              "/apollo/modules/guardian/conf/radar_detect.pb.txt",
              "The UltrasonicRadar config file");
