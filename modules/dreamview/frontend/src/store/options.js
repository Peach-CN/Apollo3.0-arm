...
export default class Options {
    ...
    @observable showTasks = OFFLINE_PLAYBACK ? false : PARAMETERS.options.defaults.showTasks;
    @observable powerOff = false;
    ...
    secondarySideBarOptions = ['showPOI', 'enableAudioCapture', 'powerOff'];
