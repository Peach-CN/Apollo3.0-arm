...
import SystemControlWebSocketEndpoint from "store/websocket/websocket_system";
...
const hostServerAddr = deduceWebsocketServerAddr("system");
export const SYSTEM_CTL_WS = new SystemControlWebSocketEndpoint(hostServerAddr);
