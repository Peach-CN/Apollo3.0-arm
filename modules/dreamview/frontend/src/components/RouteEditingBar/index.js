        ...
        return (
            <div className="route-editing-bar">
                <div className="editing-panel">
                    <RouteEditingButton label={intl.get('Add Point of Interest')}
                                        icon={addPoiIcon}
                                        onClick={() => {
                                            this.props.store.handleOptionToggle('showPOI');
                                        }}/>
                    <RouteEditingButton label={intl.get('Remove Last Point')}
                                        icon={removeLastIcon}
                                        onClick={() => {
                                            routeEditingManager.removeLastRoutingPoint();
                                        }}/>
                    <RouteEditingButton label={intl.get('Remove All Points')}
                                        icon={removeAllIcon}
                                        onClick={() => {
                                            routeEditingManager.removeAllRoutingPoints();
                                        }}/>
                    <RouteEditingButton label={intl.get('Send Routing Request')}
                                      icon={sendRouteIcon}
                                      onClick={() => {
