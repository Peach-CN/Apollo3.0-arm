...
TrajectoryPoint TrajectoryAnalyzer::QueryNearestPointByPosition(
  ...
  return trajectory_points_.size()>=FLAGS_trajectory_points_feedfowrd?
      trajectory_points_[index_min+FLAGS_trajectory_points_feedfowrd]:trajectory_points_[index_min];
}
