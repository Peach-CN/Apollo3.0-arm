...
//  void InsertObsInfo(std::list<ObsInfo>& obs_list, const ObsInfo& obs_info, double curr_s = 0.0);
  double GetMaxWidthBwteenObs(const std::list<ObsInfo> &obs_list, PathObstacle *obstacle);
};
