...
#ifndef MODULES_DRIVERS_RADAR_ULTRASONIC_RADAR_ULTRASONIC_RADAR_H_
#define MODULES_DRIVERS_RADAR_ULTRASONIC_RADAR_ULTRASONIC_RADAR_H_
...
class UltrasonicRadar : public apollo::common::ApolloApp {
 public:
 ...
 private:
  ...
  void Parse(uint8_t *data, int32_t &length);
  void SecurityDogThreadFunc();
  
  UltrasonicRadarConf ultrasonic_radar_conf_;
  std::shared_ptr<CanClient> can_client_ = nullptr;
  CanReceiver<Ultrasonic> can_receiver_;
  std::unique_ptr<UltrasonicRadarSerialStream> serial_stream_ = nullptr;
...
#endif  // MODULES_DRIVERS_RADAR_ULTRASONIC_RADAR_ULTRASONIC_RADAR_H_
