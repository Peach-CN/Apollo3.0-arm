...
void VelodyneDriver::set_base_time_from_nmea_time(NMEATimePtr nmea_time,
  ...
  ROS_INFO_STREAM("Set base unix time : " << time.tm_year << "-" << time.tm_mon
...
VelodyneDriver* VelodyneDriverFactory::create_driver(
  ...
  private_nh.param("use_gps_time", config.use_gps_time);
  ...
  if (config.model == "64E_S2" || config.model == "64E_S3S" ||
    ...
    ROS_ERROR_STREAM(
        ...
        << "|64E_S3D_STRONGEST|64E_S3D_LAST|64E_S3D_DUAL|VLP16|HDL32E|VLP32C");
    return nullptr;
  }
}
